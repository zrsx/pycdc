...
// Print exception table entries using tuple-style (preferred for new code)
void bc_exceptiontable(std::ostream& pyc_output, PycRef<PycCode> code, int indent)
{
...
// Optionally, support the old-style class for legacy compatibility
void bc_exceptiontable_entries(std::ostream& pyc_output, PycRef<PycCode> code, int indent)
{
